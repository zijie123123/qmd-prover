...
import { analyzeDependencies, inspectFact, inspectProject } from '../skills/qmd-prover/scripts/lib/inspector.mjs';
...
import { revokeVerification, submitProof } from '../skills/qmd-prover/scripts/lib/verification.mjs';
import { document, options, project, proposalPath, proof, result, staleVerifier, verifier, malformedVerifier } from './support.mjs';
