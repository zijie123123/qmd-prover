...
import { findHelpCommand, hasExactHelpCommand, isHelpGroup, renderHelp, rootUsage } from './cli-help.js';
import { AUX, cleanId, readJson } from './files.js';
import { analyzeDependencies, inspectFact, inspectPath, inspectProject, printReport } from './inspector.js';
