...
import type { Compilation, DependencyGraph, OperationResult, RuntimeOptions } from './types.js';
...
export async function renderProject(root = process.cwd(), options: RuntimeOptions = {}): Promise<OperationResult> {
