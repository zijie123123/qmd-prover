...
import { appendEvent, atomicJson, atomicWrite, AUX, newId, readJson, sha256, stableJson, withWriteLock } from './files.js';
import { readLocatedBlock, setFactMarker } from './source.js';
...
function cleanSemanticText(text: unknown, kind: string, markerAtEnd = false): string {
...
function evidencePath(root: string, relative: unknown): string | null {
...
function dependencySnapshot(compilation: Compilation, result: SemanticResult): JsonObject {
