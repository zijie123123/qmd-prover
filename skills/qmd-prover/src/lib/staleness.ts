...
import type { JsonObject, OperationResult, RuntimeOptions, SemanticResult } from './types.js';
...
export async function checkStaleness(root = process.cwd(), options: RuntimeOptions = {}): Promise<OperationResult> {
